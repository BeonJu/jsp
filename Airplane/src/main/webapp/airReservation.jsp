				...
				<table>
					...
					<tbody>
						...
						<c:forEach var="reservationTicket" items="${rList}"
							varStatus="status">
							<form name= "reservattionList" action="delete" method="get">
							<tr>
								<input type="hidden" name="pt_no" value="${reservationTicket.PT_NO }">
								<input type="hidden" name="cust_no" value="${reservationTicket.CUST_NO}">
								<input type="hidden" name="cust_name" value="${reservationTicket.CUST_NAME  }">
								<input type="hidden" name="cust_phone" value="${reservationTicket.CUST_PHONE }">
